...
To build a Docker image for your site, you'll need to create a `Dockerfile`. For example, if your site is in a directory called `src/`, you could create this `Dockerfile`:
    ...
    FROM libretto/static-nginx-alpine
    COPY src/ /var/www
...
Docker Hub
----------
The trusted build information can be found on the Docker Hub at https://hub.docker.com/r/libretto/static-nginx-alpine/.
...
```dockerfile
# Guide here:
# https://github.com/LibrettoTeam/docker-nginx-alpine
